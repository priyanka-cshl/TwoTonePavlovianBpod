...
function varargout = PriyankaBpodParameterGUI(varargin)
            ...
            switch ThisParamStyle
                case 1 % Edit
                    ...
                    if ~isnan(GUIParam)
                        ...
                        Params.GUI.(ThisParamName) = get(ThisParamHandle, 'String'); % hack to prevent vector inputs to be replaced by NaN
                    end
                case 2 % Text
